...
function primeNumberF() {
    var primeNumber = prompt('Введите любое положительное число больше 1 ', 2);
    if (parseInt(primeNumber, 10) > 1) {
        var j = 1;
        for (var i = 1; i <= parseInt(primeNumber); i++) {
            while (j < i) {
                if (i % j == 0) {
                    console.log(i);
                }
    ...
    } else if (parseInt(primeNumber) <= 1) {
        primeNumber = alert('Число должно быть больше 1');
        primeNumberF();
    } else {
